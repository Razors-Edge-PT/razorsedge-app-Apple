...
class ThemeController extends ChangeNotifier {
  ...
  /// Update colors or theme mode and persist them.
  Future<void> update({Color? primary, Color? secondary, ThemeMode? mode}) async {
    final prefs = await SharedPreferences.getInstance();
    if (primary != null) {
  ...
  Color nearestAllowedColor(
    ...
    const shadeValues = [50, 300, 400, 500, 600, 700, 800, 1000];
