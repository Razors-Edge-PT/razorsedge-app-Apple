...
class _CreateTemplateScreenState extends State<CreateTemplateScreen> {
  ...
  final generatedId = 'template_${DateTime.now().millisecondsSinceEpoch}_${Random().nextInt(1000)}';
  ...
  Future<void> _fetchExercises() async {
    try {
      ...
      final exerciseList = querySnapshot.docs.map((doc) => Exercise(
        id: doc.id,
        name: doc.get('name'),
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              Expanded( // Ensures remaining space is filled by the list
  ...
  void _submitTemplate(BuildContext context) {
    if (_formKey.currentState!.validate()) {
      ...
      final newTemplate = Template(
        ...
        name: _name,
        day: _day,
        exercises: _selectedExercises.map((id) => _exerciseNameMap[id]!).toList(), // Convert IDs to names
      );

      addTemplateToFirestore(newTemplate, generatedId)
          .then((_) {
