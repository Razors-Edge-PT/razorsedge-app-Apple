...
class ThemeController extends ChangeNotifier {
  ...
  void preview({Color? primary, Color? secondary, Color? tertiary, ThemeMode? mode}) {
  ...
  Future<void> update({Color? primary, Color? secondary, Color? tertiary, ThemeMode? mode}) async {
    final prefs = await SharedPreferences.getInstance();
    if (primary != null) {
