...
class BB3TemplatePicker extends StatefulWidget {
  final String uid;
  final String? activeBlockId;

  const BB3TemplatePicker({
    super.key,
    required this.uid,
    this.activeBlockId,
  });
  ...
  @override
  State<BB3TemplatePicker> createState() => _BB3TemplatePickerState();
}

class _BB3TemplatePickerState extends State<BB3TemplatePicker> {
