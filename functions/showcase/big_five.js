...
const BIG_FIVE = [
  ...
  },
  {
    ...
    // The stored load includes the athlete's bodyweight: its records are
    // chosen and shown on normalised loads (see showcase/bodyweight.js), while
    // fingerprints still name the stored set.
